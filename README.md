...
- Остальные негативные сценарии обрабатываются корректно: попытка очистить имя пользователя, создание пользователя с пустым логином, создание пользователя без пароля, создание пользователя с пустым именем, удаление несуществующего пользователя.
